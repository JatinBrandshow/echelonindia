    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100">
            ...
            <section className="py-20 relative">
                <div className="absolute top-0 left-0 w-full h-72 bg-gradient-to-b from-blue-50 to-white -z-10"></div>
                <div className="container mx-auto px-6">
                    <div className="flex flex-col lg:flex-row gap-12">
                            ...
                            <div className="bg-white rounded-2xl shadow-xl p-8 md:p-10">
                                ...
                                {isSubmitted ? (
                                    ...
                                    <form onSubmit={handleSubmit} className="space-y-6">
                                        ...
                                        <button
                                            type="submit"
                                            className="w-full bg-gradient-to-r from-blue-600 to-indigo-700 hover:from-blue-700 hover:to-indigo-800 text-white font-semibold py-3 px-6 rounded-lg transition-all duration-300 transform hover:-translate-y-1 shadow-lg hover:shadow-blue-500/30"
                                        >
                                            Send Message
                                        </button>
                                    </form>
                        ...
                        <motion.div
                            ...
                            className="lg:w-1/2"
                        >
                            <div className="bg-gradient-to-br from-blue-800 to-indigo-900 text-white rounded-2xl shadow-xl p-8 md:p-10 h-full">
                                <h2 className="text-2xl md:text-3xl font-bold mb-8">Contact Information</h2>

                                <div className="space-y-8">
                                    <div className="flex items-start">
                                        <div className="bg-blue-700 p-3 rounded-lg mr-4 flex-shrink-0">
                                    ...
                                    <div className="flex items-start">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-blue-100 mb-1">+91 123 456 7890</p>
                                    ...
                                    <div className="flex items-start">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-blue-100 mb-1">info@dynamiceminent.com</p>
                                            <p className="text-blue-100">sales@dynamiceminent.com</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex space-x-4">
                                        {[
                                            ...
                                            <a
                                                key={index}
                                                href="#"
                                                className={`w-10 h-10 bg-blue-700 rounded-full flex items-center justify-center text-white transition-all duration-300 transform hover:-translate-y-1 ${social.color}`}
