                ...
                <div className="container mx-auto px-4 md:px-8">
                    ...
                    <div className="flex flex-col lg:flex-row gap-10 lg:gap-16">
                        ...
                        <motion.div
                            ...
                            className="lg:w-1/2"
                        >
                            <div className="bg-blue-950 hover:bg-blue-900 text-white rounded-2xl shadow-xl p-8 md:p-10 h-full">
                                <div className="flex flex-col lg:flex-row gap-8">
                                    ...
                                    <div className="lg:w-2/3">
                                        ...
                                        <div className="space-y-8">
                                            <div className="flex items-start">
                                                <div className="bg-blue-950 hover:bg-blue-900 p-3 rounded-lg mr-4 flex-shrink-0">
                                            ...
                                            <div className="flex items-start">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-white mb-1">+91 123 456 7890</p>
                                                    <p className="text-white">+91 987 654 3210</p>
                                                </div>
                                            </div>
                                            ...
                                            <div className="flex items-start">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-white mb-1">info@dynamiceminent.com</p>
                                                    <p className="text-white">sales@dynamiceminent.com</p>
                                                </div>
                                            </div>
                                            ...
                                            <div className="flex space-x-4">
                                                {[
                                                    ...
                                                    <a
                                                        key={index}
                                                        href="#"
                                                        className={`w-10 h-10 bg-blue-950 hover:bg-blue-900 rounded-full flex items-center justify-center text-white transition-all duration-300 transform hover:-translate-y-1 ${social.color}`}
                                    ...
                                    <div className="lg:w-1/3 flex items-center justify-center">
                                        <div className="relative w-full h-96 lg:h-[500px] overflow-hidden">
                                            <img
                                                src="images/contact/lady-img.png"
                                                alt="Office building"
