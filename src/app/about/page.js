                    ...
                    <div className="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12">
                        ...
                        >
                            ...
                            <motion.p
                                ...
                                className="text-base sm:text-lg text-gray-300 mb-8 sm:mb-10 leading-relaxed"
                            >
                            ...
                            >
                                <button className="relative group bg-gradient-to-r from-cyan-500 to-blue-600 text-white px-6 py-3 sm:px-8 sm:py-4 rounded-xl font-semibold overflow-hidden transition-all duration-300 hover:shadow-2xl hover:shadow-cyan-500/30 text-sm sm:text-base">
                                    <span className="relative z-10">Our Story</span>
                                    <div className="absolute inset-0 bg-gradient-to-r from-cyan-600 to-blue-700 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                                </button>

                                <button className="relative group bg-transparent border-2 border-white/30 text-white px-6 py-3 sm:px-8 sm:py-4 rounded-xl font-semibold overflow-hidden transition-all duration-300 hover:border-white/60 hover:bg-white/10 text-sm sm:text-base">
                            ...
                            <motion.div
                                ...
                                className="grid grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 border-t border-white/10 pt-6 sm:pt-8"
                            >
                                {[
                        ...
                        >
                            <div className="relative w-full max-w-2xl mx-auto">
                                ...
                                <motion.div
                                    ...
                                    className="absolute -top-4 -right-4 sm:-top-6 sm:-right-6 bg-white/10 backdrop-blur-md p-3 sm:p-4 rounded-xl sm:rounded-2xl border border-white/20 shadow-2xl max-w-[140px] sm:max-w-[180px]"
                                >
                                    <div className="text-white text-xs sm:text-sm font-medium">Quality Craftsmanship</div>
                                    <div className="text-cyan-300 text-[10px] sm:text-xs">Since 1989</div>
                                </motion.div>
                                ...
                                <motion.div
                                    ...
                                    className="absolute -left-4 sm:-left-6 bg-white/10 backdrop-blur-md p-3 sm:p-4 rounded-xl sm:rounded-2xl border border-white/20 shadow-2xl max-w-[140px] sm:max-w-[180px]"
                                >
                                    <div className="text-white text-xs sm:text-sm font-medium">Sustainable Development</div>
                                    <div className="text-cyan-300 text-[10px] sm:text-xs">Green Initiatives</div>
                                </motion.div>
                            </div>
                        </motion.div>
                    </div>
