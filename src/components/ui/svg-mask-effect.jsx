...
export const MaskContainer = ({
    ...
    return (
        <motion.div
            ...
            <motion.div
                className="absolute flex h-full w-full items-center justify-center bg-black text-6xl [mask-image:url(/svg/mask.svg)] [mask-repeat:no-repeat] [mask-size:40px] dark:bg-white"
                animate={{
